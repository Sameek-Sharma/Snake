...
FPS = 10 #Sets Speed, CHANGED FROM 15 TO 10
WINDOWWIDTH = 1440 #game window width (x-direction), CHANGED FROM 640 to 
WINDOWHEIGHT = 1080 #game window height (y-direction), CHANGED FROM 480 TO 1080
